...
//
// Extension provided by Udacity for course titled: "Intro to iOS App Development with Swift"
...
extension PlaySoundsViewController: AVAudioPlayerDelegate {
    ...
    //a convenient place to have all alert messages in one place
    struct Alerts {
    ...
    //will set the button states dependin if we're Playing/Not playing
    enum PlayingState { case Playing, NotPlaying }

    
    // MARK: Audio Functions
    
    //try to load the audio file from the recordSoundsViewController 
